            ...
            <div className='flex flex-col justify-center items-center gap-[3rem]'>
                {signRequest === ""? (
                     ...
                     <div className='flex flex-col gap-2 w-fit mx-auto'>
                       ...
                       <Button click={()=>setSignRequest(createUser?"sign-up":"sign-in")} icon={<AiOutlineMail className='text-xl'/>} text={`${createUser ? "Sign Up" : "Sign In"} With Mail`}/>
                     </div>
                     <p>
                 ...
                 Terms of Service and acknowledge that Medium’s Privacy Policy applies to you.
                 </p>
            </div>
        </section>
    </Modal>
...
const Button = ({icon,text,click}) => {
  return (
    <button onClick={click} className='flex items-center gap-10 sm:w-[20rem] border border-black
